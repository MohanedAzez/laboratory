...
@section('content-backend')
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <div class="container">
            <h2>{{__('site.news')}}
                <button class="btn btn-warning add-btn" style="float: right" data-toggle="modal" data-target="#basicExampleModal">{{__('site.addNews')}}</button>
            </h2>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th scope="col">{{__('site.tittle')}}</th>
                    <th scope="col">{{__('site.Picture')}}</th>
                    <th scope="col">{{__('site.desc')}}</th>
                ...
                @foreach($news as $key=>$row)
                    <tr>
                        ...
                        <td>{{$row->desc}} </td>
                        <td>
                            <a href="{{route('admin.news.edit', $row->id)}}" class="btn btn-sm btn-info" title="edit"><i class="fa fa-edit"></i></a>
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{route('news.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="text-align: right" class="form-control" name="tittle_news" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="{{__('site.tittle')}}" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" style="text-align: right" name="details_news" id="exampleFormControlTextarea3" rows="3"></textarea>
                                </div>
                                <div class="modal-footer">
