           ...
           @include('admin.error')
            ...
            <form method="post" action="{{route('staff.update', $staff->id)}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" style="text-align: right" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$staff->name}}" required>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-top: 20px">
                    <div class="col-lg-12">
                        ...
                        <div class="custom-file"><span class="tx-danger">*</span>
                            <input type="hidden" value="{{$staff->picture}}"  class="custom-file-input"  aria-describedby="inputGroupFileAddon01" name="old_pic">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="text-align: right" name="spec" id="exampleFormControlTextarea3" rows="3">{{$staff->specialization}}</textarea>
                </div>
